...
SOURCE = (
    ...
    / "work/blind-phase-confirmatory-v2/recover_activation_mounts_v6.py"
)
SPEC = importlib.util.spec_from_file_location("recover_activation_mounts_v6", SOURCE)
...
def test_v5_project_only_runner_can_invoke_only_project_umount(
    ...
    assert str(RECOVERY.V6_RESUME_PATH) in journal
