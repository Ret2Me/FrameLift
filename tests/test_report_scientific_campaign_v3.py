...
SCRIPT = Path(__file__).resolve().parents[1] / 'work/blind-phase-confirmatory-v2/report_scientific_campaign_v3.py'
spec = importlib.util.spec_from_file_location('campaign_v3_terminal_report_test', SCRIPT)
