...
types:
  ...
  beacon_t:
    ...
    instances:
      bcn_temp_digital:
        value: '(bcn_temp_digital_raw >> 4) >= 2048 ? (bcn_temp_digital_raw >> 4) - 4096 : (bcn_temp_digital_raw >> 4)'
      bcn_temp_ana:
        value: '(bcn_temp_ana_raw >> 4) >= 2048 ? (bcn_temp_ana_raw >> 4) - 4096 : (bcn_temp_ana_raw >> 4)'
      bcn_temp_cdh:
        value: '(bcn_temp_cdh_raw >> 4) >= 2048 ? (bcn_temp_cdh_raw >> 4) - 4096 : (bcn_temp_cdh_raw >> 4)'
      bcn_temp_backplane:
        value: '(bcn_temp_backplane_raw >> 4) >= 2048 ? (bcn_temp_backplane_raw >> 4) - 4096 : (bcn_temp_backplane_raw >> 4)'
