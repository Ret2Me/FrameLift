...
SOURCE = (
    ...
    / "work/blind-phase-confirmatory-v2/recover_activation_mounts_v1.py"
)
SPEC = importlib.util.spec_from_file_location("recover_activation_mounts_v1", SOURCE)
...
def _install_run_mocks(
    ...
    monkeypatch.setattr(RECOVERY, "_regular_identity", lambda path: dict(identity, path=str(path)))
